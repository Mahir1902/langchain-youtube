...
export default async function page({ params: { chatId } }: Props) {
  ...
  return (
    <div className="flex h-full w-full">
      <div className="bg-gray-900 hidden md:w-72 md:flex h-full md:fixed md:flex-col md:inset-y-0 text-white z-[80] ">
        <div className="flex flex-col space-y-4 h-full text-white">
          <div className="px-3 py-2  max-h-[6rem] text-center">
